...
\begin{document}
	...
	\author{\IEEEauthorblockN{Yue Dong}
		...
		\and
		\IEEEauthorblockN{Vladimir Pestov}
		\IEEEauthorblockA{Department of Mathematics \\ and Statistics\\
			University of Ottawa\\
			Ottawa, Ontario\\
			vpest283@uottawa.ca 
		...
		SMNN and SENN satisfy the desirable properties of learning systems for efficient data stream mining proposed by G. Hulten and P. Domingos \cite{Pedro}: they require small constant time per data example; they use fixed amount of main memory, irrespective of the total number of examples; they build models using a single scan over the training data; they generate anytime models independent from the order of the examples; and they have the ability to deal with concept drift. 
